...
async function handleRequest(event) {
    const API_URL = 'https://stable.demo.geonode.org/api/v2/datasets?page_size=100'
    // Cache
    ...
    */
    ...
    if (!response) { 
    console.log(`Response for url: ${API_URL} not present in cache`);
    ...
    event.waitUntil(cache.put(API_URL, response.clone()))
    }
